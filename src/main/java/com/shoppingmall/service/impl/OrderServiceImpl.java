...
public class OrderServiceImpl implements IOrderService {
    ...
    private OrderVo assembleOrderVo(Order order, List<OrderItem> orderItemList) {
        ...
        orderVo.setImageHost(PropertiesUtil.getProperty("QiNiu_Bind_Domain_Name"));
    ...
    private Order assembleOrder(Integer userId, Integer shippingId, BigDecimal payment) {
        ...
        // TODO: 2017/7/11 发货时间的设置

        // TODO: 2017/7/11 付款时间的设置
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        String subject = new StringBuilder().append("shopping mall 扫码支付, 订单号: ").append(outTradeNo).toString();
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                String qrUrl = PropertiesUtil.getProperty("QiNiu_Bind_Domain_Name") + targetFile.getName();
